...
# 정면 경로 검사
PATH_CHECK_DIST  = 520.0
PATH_DANGER_DIST = 480.0
PATH_BLOCK_POINTS = 3
...
AVOID_SPEED_MIN = 0.18   # 장애물이 매우 가까울 때
BACK_SPEED     = 0.35
ESCAPE_SPEED   = 0.22
...
GAP_MIN_DIST_JUMP    = 120.0
GAP_WALL_FAR_THRESH  = 1200.0
GAP_WALL_NEAR_THRESH = 400.0
